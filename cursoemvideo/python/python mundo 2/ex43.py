peso = float(input('Digite seu peso em kg(ex: 62.4): ')) # solicitando o peso do usuário
altura = float(input('Digite sua altura em metros(ex: 1.74)')) # solicitando a altura do usuário
